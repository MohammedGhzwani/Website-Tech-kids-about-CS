                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            ...
                            <div>
                                <a href="fomrs/student-edit-account.php" class="btn btn-light ml-3"><i class="material-icons">edit</i> Edit</a>
                                <a href="student-profile.php" class="btn btn-success ml-1">View Profile <i class="material-icons">account_circle</i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        ...
                        <div class="alert alert-soft-warning d-flex align-items-center card-margin p-2" role="alert">
                            ...
                            <a href="student-dashboard.php" class="btn btn-warning ml-auto">Upgrade</a>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 card-group-row__col">
                                <div class="card card-group-row__card ">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <a href="student-dashboard.php#" class="text-dark mb-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <a href="courses.php" class="btn btn-light">Browse All</a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-flush mb-0" style="z-index: initial;">
                                        ...
                                        <li class="list-group-item" style="z-index: initial;">
                                            <div class="d-flex align-items-center">
                                                <a href="student-dashboard.php#" class="mr-3">
                                                ...
                                                <div class="flex">
                                                    <a href="student-dashboard.php#" class="text-body"><strong>Basics of Social Media</strong></a>
                                                    <div class="d-flex align-items-center">
                                                ...
                                                <div class="dropdown ml-3">
                                                    <a href="student-dashboard.php#" class="dropdown-toggle text-muted" data-caret="false" data-toggle="dropdown">
                                                        <i class="material-icons">more_vert</i>
                                                    </a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="student-dashboard.php#">View Stats</a>
                                                        <a class="dropdown-item" href="student-dashboard.php#">Proceed</a>
                                                        <a class="dropdown-item" href="student-dashboard.php#">Close</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item" style="z-index: initial;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <a href="student-dashboard.php#" class="text-body"><strong>Learn Vue.js Fundamentals</strong></a>
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress" style="width: 100px; height:4px;">
                                        ...
                                        <li class="list-group-item" style="z-index: initial;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <a href="student-dashboard.php#" class="text-body"><strong>Angular in Steps</strong></a>
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress" style="width: 100px; height:4px;">
                                        ...
                                        <li class="list-group-item" style="z-index: initial;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex">
                                                    <a href="student-dashboard.php#" class="text-body"><strong>ES6 Foundations</strong></a>
                                                    <div class="d-flex align-items-center">
                                                        <div class="progress" style="width: 100px; height:4px;">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        ...
                                        <div class="dropdown ml-auto">
                                            <a class="btn btn-sm btn-light" href="student-dashboard.php#">View all</a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-flush mb-0">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-body mb-1" href="student-dashboard.php#"><strong>Level 1 HTML</strong></a><br>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="https://lema.frontted.com/take-course.php" class="small">Basics of HTML</a>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-body mb-1" href="student-dashboard.php#"><strong>Level 2 Angular</strong></a><br>
                                                    <div class="d-flex align-items-center">
                                                        <span class="text-blue mr-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                                        ...
                                                        <a href="https://lema.frontted.com/take-course.php" class="small">Angular in Steps</a>
                                                    </div>
                                                </div>
                                                <div class="media-right text-center d-flex align-items-center">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-body mb-1" href="student-dashboard.php#"><strong>Graduation</strong></a><br>
                                                    <div class="d-flex align-items-center">
                                                        <span class="text-blue mr-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                                <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                                        ...
                                                        <a href="https://lema.frontted.com/take-course.php" class="small">Bootstrap Foundations</a>
                                                    </div>
                                                </div>
                                                <div class="media-right text-center d-flex align-items-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card card__course">
                                    <div class=" d-flex justify-content-center">
                                        <a class="" href="student-dashboard.php#">
                                    ...
                                    <div class="p-3">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <a class="text-body mb-1" href="student-dashboard.php#"><strong>Basics of Social Media</strong></a><br>
                                                <div class="d-flex align-items-center">
                                                    <span class="text-blue mr-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="16" height="16" style="position:relative; top:-2px">
                                                            <g transform="matrix(1.6666666666666667,0,0,1.6666666666666667,0,0)">
                                                    ...
                                                    <a href="https://lema.frontted.com/take-course.php" class="small">Social Media</a>
                                                </div>
                                            </div>
                                            <a href="student-dashboard.php#" class="btn btn-primary ml-auto">Resume <i class="material-icons">arrow_forward</i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header card-header-tabs-basic nav" role="tablist">
                                        <a href="student-dashboard.php#activity_all" class="active" data-toggle="tab" role="tab" aria-controls="activity_all" aria-selected="true">All</a>
                                        <a href="student-dashboard.php#activity_purchases" data-toggle="tab" role="tab" aria-controls="activity_purchases" aria-selected="false">Purchases</a>
                                        <a href="student-dashboard.php#activity_emails" data-toggle="tab" role="tab" aria-controls="activity_emails" aria-selected="false">Emails</a>
                                        <a href="student-dashboard.php#activity_quotes" data-toggle="tab" role="tab" aria-controls="activity_quotes" aria-selected="false">Quotes</a>
                                    </div>
                                    <div class="list-group tab-content list-group-flush">
                                        <div class="tab-pane active show fade" id="activity_all">
                                            ...
                                            <div class="card-footer text-center border-0">
                                                <a class="text-muted" href="student-dashboard.php">View All (54)</a>
                                            </div>
                                        </div>
