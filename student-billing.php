                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            ...
                            <a href="student-billing.php" class="btn btn-primary ml-lg-3">Make Payment</a>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid page__container">
                        <div class="alert alert-soft-warning d-flex align-items-center card-margin" role="alert">
                            ...
                            <div class="text-body">
                                You have an invoice <a href="student-billing.php#">#21387</a> due for
                                <strong class="text-danger">$49.00</strong>
                            </div>
                            <a href="student-billing.php" class="btn btn-warning ml-auto">Pay Now!</a>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="https://lema.frontted.com/invoice.php">#<span>12199</span></a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="https://lema.frontted.com/invoice.php">#<span>38331</span></a>
                                                    </td>
                                                    <td class="text-center">
                                                        $49.00
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="https://lema.frontted.com/invoice.php">#<span>58331</span></a>
                                                    </td>
                                                    <td class="text-center">
                                                        $49.00
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="https://lema.frontted.com/invoice.php">#<span>23421</span></a>
                                                    </td>
                                                    <td class="text-center">
                                                        $49.00
                                                    </td>
