                    ...
                    <div class="mdk-drawer-layout__content page">
                        ...
                        <div class="container-fluid page__container">
                                ...
                                <div class="col-md-3">
                                    <div class="card card__course" data-aos="fade-up" data-offset="-100">
                                        <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                                            <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="index.php#">
                                        ...
                                        <div class="p-3">
                                            <div class="mb-2">
                                                <span class="mr-2">
                                                    <a href="index.php#" class="rating-link active"><i class="material-icons icon-16pt">star</i></a>
                                                    <a href="index.php#" class="rating-link active"><i class="material-icons icon-16pt">star</i></a>
                                                    <a href="index.php#" class="rating-link active"><i class="material-icons icon-16pt">star</i></a>
                                                    <a href="index.php#" class="rating-link active"><i class="material-icons icon-16pt">star</i></a>
                                                    <a href="index.php#" class="rating-link active"><i class="material-icons icon-16pt">star_half</i></a>
                                                </span>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="index.php#" class="btn btn-primary ml-auto"><i class="material-icons">add_shopping_cart</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-center m-4 pb-4" data-aos-duration="1000" data-aos="fade-up">
                                <a href="index.php#" class="btn btn-light btn-lg">View All</a>
                            </div>
                                ...
                                <div class="row p-4">
                                    <div class="col-md-6 offset-md-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="index.php#" class="btn btn-secondary ml-2" data-aos="flip-left" data-aos-duration="800" data-aos-delay="150">SUBSCRIBE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
