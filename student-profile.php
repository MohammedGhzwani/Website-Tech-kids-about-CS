                                ...
                                <div class="card">
                                    <div class="border-bottom">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <a href="student-profile.php" class="btn btn-facebook btn-sm"><i class="fab fa-facebook"></i></a>
                                            <a href="student-profile.php" class="btn btn-twitter btn-sm"><i class="fab fa-twitter"></i></a>
                                            <a href="student-profile.php" class="btn btn-light btn-sm"><i class="fab fa-github"></i></a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="student-profile.php#" class="text-muted mb-2">Courses Taken</a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="student-profile.php#" class="text-muted mb-2">Overall Score</a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <a href="student-profile.php#" class="text-muted mb-2">Quizzes Taken</a>
                                        ...
                                        <div class="d-flex mb-1">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p><a href="student-profile.php">#themeforest</a> <a href="student-profile.php">#EnvatoMarket</a></p>
                                                </div>

                                                <div class="d-flex align-items-center">
                                                    <a href="student-profile.php" class="text-muted d-flex align-items-center decoration-0"><i class="material-icons mr-1" style="font-size: inherit;">favorite_border</i> 38</a>
                                                    <a href="student-profile.php" class="text-muted d-flex align-items-center decoration-0 ml-3"><i class="material-icons mr-1" style="font-size: inherit;">thumb_up</i> 71</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="d-flex mb-1">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div>
                                                    <p>Rails 5 Bootstrap 4 Boilerplate Admin Dashboard on <a href="student-profile.php">https://t.co/Wh7jE0yz4t</a> 😉
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="student-profile.php" class="text-muted d-flex align-items-center decoration-0"><i class="material-icons mr-1" style="font-size: inherit;">favorite_border</i> 156</a>
                                                    <a href="student-profile.php" class="text-muted d-flex align-items-center decoration-0 ml-3"><i class="material-icons mr-1" style="font-size: inherit;">thumb_up</i> 351</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
