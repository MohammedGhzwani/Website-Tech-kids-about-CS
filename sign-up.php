...
<body class="layout-login-centered-boxed">
    ...
    <div class="layout-login-centered-boxed__form">
        ...
        <div class="card card-body">
            <a href="sign-up.php" class="btn btn-light btn-block">
                <span class="mr-2">
            ...
            <form action="index.php" novalidate>
                ...
                <div class="form-group mb-2 text-center">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="terms">I accept <a href="sign-up.php#">Terms and Conditions</a></label>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <span>Have an account?</span> <a class="text-body text-underline" href="login.php"> Login</a>
                </div>
            </form>
        </div>
    </div>
